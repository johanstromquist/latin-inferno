...
const INFERNO = {
  ...
  /* ---------------------------------------------------------------- 1 limbo */
  {
    ...
    challenges:[
      ...
      { type:"grammar", crit:"grammar", grade:"E", title:"En annan böjning",
        q:"Skriv <b>ackusativ singular</b> av <b>via</b> (vägen, som objekt):",
        accept:["viam"], answerLabel:"viam",
        explain:"Samma mönster, annat ord: 1:a dekl. ack. sg. = <b>-am</b>. <i>viam</i> (vägen). Igenkänning av ändelsen, inte av ett enda ord." },
      { type:"translatio", crit:"text", grade:"C", title:"Bygg den latinska satsen",
        act:"Bygg satsen själv på latin — ändelsen, inte ordföljden, avgör rollen.",
        q:"Sätt ihop latinet för: <b>Skalden älskar flickan.</b>",
        hint:"poēta = skald (subjekt, nom.) · puellam = flickan (objekt, ack. -m) · amat = älskar",
        assemblePrompt:"Bygg satsen i latinets normala ordföljd (subjekt – objekt – verb):",
        solution:["poēta","puellam","amat"],
        explain:"<b>poēta</b> (nom) = subjekt, <b>puellam</b> (-m, ack) = objekt. Latinet är fritt i ordföljd, men subjekt–objekt–verb är det vanligaste." },
  ...
  /* ---------------------------------------------------------------- 2 lust */
  {
    ...
    challenges:[
      ...
      { type:"translatio", crit:"text", grade:"C", title:"Bygg Francescas rad på latin",
        q:"Sätt ihop latinet för: <b>Kärleken besegrar mig.</b>",
